...
ComPtr<ID3D12RootSignature> CreateComputeRootSig(ID3D12Device14 &Device)
{
    ...
    RootParam[ComputeRootParams::ScreenCB_b3].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
    RootParam[ComputeRootParams::ScreenCB_b3].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;
    RootParam[ComputeRootParams::ScreenCB_b3].Descriptor.ShaderRegister = 4;
    RootParam[ComputeRootParams::ScreenCB_b3].Descriptor.RegisterSpace = 0;
...
ComPtr<ID3D12RootSignature> CreateGraphicsRootSig(ID3D12Device14 &Device)
{
    ...
    // --- UAV range ---
    D3D12_DESCRIPTOR_RANGE DebugRange{};
    DebugRange.RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_UAV;
    DebugRange.NumDescriptors = 1;
    DebugRange.BaseShaderRegister = 1;
    DebugRange.RegisterSpace = 0;
    ...
    D3D12_ROOT_DESCRIPTOR_TABLE DebugTable{};
    DebugTable.NumDescriptorRanges = 1;
    DebugTable.pDescriptorRanges = &DebugRange;
    ...
    RootParam[GraphicsRootParams::ParticleSRV_t0].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;
    ...
    RootParam[GraphicsRootParams::ScreenCB_b4].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;
    RootParam[GraphicsRootParams::ScreenCB_b4].Descriptor.ShaderRegister = 4;
    RootParam[GraphicsRootParams::ScreenCB_b4].Descriptor.RegisterSpace = 0;
    RootParam[GraphicsRootParams::ScreenCB_b4].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
    ...
    RootParam[GraphicsRootParams::DensityTexSRV_t1].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;

    //RootParam[GraphicsRootParams::DebugUAV_u0].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
    //RootParam[GraphicsRootParams::DebugUAV_u0].DescriptorTable = DebugTable;
    //RootParam[GraphicsRootParams::DebugUAV_u0].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
    // Root signature
