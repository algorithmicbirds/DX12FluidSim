...
ComPtr<ID3D12RootSignature> CreateComputeRootSig(ID3D12Device14 &Device)
{
    ...
    RootParam[ComputeRootParams::SimParamsCB_b2] = CreateCBV(2);
    RootParam[ComputeRootParams::PrecomputedKernalCB_b3] = CreateCBV(3);
    RootParam[ComputeRootParams::ScreenCB_b4] = CreateCBV(4);
    ...
    RootParam[ComputeRootParams::DensityTexUAV_t2] = CreateTableParam(DensityRange);
